...
class FakeDataDaoTest {
  ...
  void shouldGetUserById() {
    ...
    User user = new User(userId, "test@email.com", "spring", "boot", Gender.MALE, 20);

    fakeData.insertUser(userId, user);
  ...
  void shouldInsertUser() {
    ...
    assertThat(fakeData.getUser(userId).get()).isEqualToComparingFieldByField(user);
  }
